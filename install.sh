...
#sudo -s
#apt install -y ./libgoocanvas-common_1.0.0-1_all.deb
#apt install -y ./libgoocanvas3_1.0.0-1_amd64.deb
#apt install -y ./libgoo-canvas-perl_0.06-2ubuntu3_amd64.deb
